...
> **La phrase qui présente le message tutoie, le message vouvoie.** C'est la seule ligne du pack où les deux registres se touchent, et c'est là qu'ils se mélangent. « Suite à ton appel, voici l'email » puis, dans le bloc, « Suite à notre appel de ce matin ». La règle n'est pas au-dessus du bloc, elle est **dans son introduction**, parce que c'est l'introduction qui se trompe.
...
**L'étape de l'affaire** bouge avec le mail : un devis parti, une proposition envoyée passent l'affaire à `Proposition`. La proposer, jamais la poser seul. La bascule appartient à `creer-opportunite`, étape 4, qui pose du même geste la relance obligatoire et réclame la date de clôture prévue. C'est là aussi que se pose la question de l'identité de l'entreprise, quand son SIRET manque pour le devis : elle part avec la bascule, pas avec le mail.
...
- **Un message sortant n'engage que ce que l'utilisateur a dit.** Ce qui part chez un tiers ne contient aucune intention, aucune promesse, aucune présence annoncée que l'utilisateur n'ait formulée dans la conversation ou que la base ne porte. **Une information reçue n'est pas un engagement pris** : « il m'a conseillé cet événement » se remercie, il ne s'y répond pas « j'y serai ». Dans le doute, la phrase se retire, ou se pose en question à l'utilisateur avant l'envoi. **C'est le seul endroit du pack où une erreur ne se rattrape pas** : le briefing du lendemain corrigera une date fausse, personne ne rattrapera un email parti. Et l'invention se propage : celle du 1er septembre 2026 a produit une tâche datée, donc une obligation future consignée en base.
  - **Six choses ne s'engagent jamais sans l'utilisateur, et la liste se coche** : une disponibilité, un rappel, un délai de réponse, un envoi de document, un tarif, une présence à une date. Une liste se relit sur le message écrit, une règle générale ne se relit pas. Le 2 septembre 2026, l'email s'est terminé par « Je reste disponible si l'un de vos clients a des questions ou souhaite en discuter directement », et rien du tour ne portait cette disponibilité.
