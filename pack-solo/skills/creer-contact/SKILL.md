...
> Super Super, qu'est-ce qui te les fait mettre là, chez eux ?

**Demander *en quoi*, jamais *si*.** Une entreprise dont on est en train d'ajouter un contact est déjà une entreprise qui intéresse : « c'est le genre de boîte que tu cherches, ou c'est plutôt à côté ? » a une réponse par défaut, elle est « oui », et une question dont on connaît la réponse ne rapporte rien. Pire, elle rend un mot là où le champ voisin attend une phrase : `Correspondance cible` se remplit, `Pourquoi eux` reste vide, et le seul des deux qui portera encore de l'information dans six mois est celui qu'on n'a pas rempli. La question ouverte remplit les deux d'un coup, **le classement et sa raison**, sans coûter un tour de plus.
...
> Perfhomme, qu'est-ce qui te les fait mettre là, chez eux ? Je le note une fois pour toutes, ça vaudra pour tous leurs contacts.
