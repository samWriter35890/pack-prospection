...
**Deux questions au maximum, et en prose, jamais en liste à puces.** Ce qui a été tranché sans certitude s'annonce comme un fait corrigeable, dans la phrase de confirmation et sans point d'interrogation : c'est une information, pas une question de plus. Le 25 août 2026, cette étape a rendu trois puces interrogatives puis quatre, et c'est très exactement la forme que le mode lot a appris à éviter. **Jamais deux fois la même question.** Sur un lot de personnes, la question de la cible se pose **par entreprise**, une seule fois pour toutes celles de la même boîte, et à la fin du lot comme les coordonnées. Cinq contacts chez trois entreprises font trois questions, pas cinq, et pas quinze.
