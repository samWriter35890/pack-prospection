...
> **Un échange tracé ici entraîne les mêmes conséquences que s'il avait été consigné par le chemin ordinaire.** Une invitation acceptée est un échange **entrant** : elle fait avancer `Statut relation` sur le contact, exactement comme le décrit `enregistrer-echange`, étape 3. La règle ne se recopie pas ici, elle s'applique.
>
