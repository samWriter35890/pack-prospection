...
> **« Jamais approché » se vérifie sur les échanges, pas seulement sur le statut de la relation.** Un contact qui porte un échange, quel qu'en soit le canal et le sens, n'est pas un contact jamais approché, même si son statut ne l'a pas suivi. Et **un contact entré dans la base aujourd'hui ou hier ne se propose jamais à la relance** : il vient d'arriver.
>
