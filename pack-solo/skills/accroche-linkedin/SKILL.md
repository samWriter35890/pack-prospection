...
- **Un lien s'écrit `{"Id": <numéro>}`** sur le champ de lien.
...
Par défaut, ce skill **n'écrit rien en base**. Sur demande, une seule écriture utile :
...
- **Rien de scrapé ne va en base.** L'enrichissement de profil sert au message, puis disparaît.
